		...
		const char *username, const char *password, const char *sensor, int command, const char *key)
{
	...
	substitute_simple_macros(NULL, NULL, NULL, NULL, &hostid, NULL, NULL, NULL, NULL, &user,
			MACRO_TYPE_COMMON, NULL, 0);
	substitute_simple_macros(NULL, NULL, NULL, NULL, &hostid, NULL, NULL, NULL, NULL, &pwd,
			MACRO_TYPE_COMMON, NULL, 0);
